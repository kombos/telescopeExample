...
export interface AminoMessage extends AminoMsg {
  type: "/assetmantle.splits.v1beta1.transactions.unwrap.Message";
  value: {
    from: string;
    from_i_d: {
      hash_i_d: {
...
export const AminoConverter = {
  "/assetmantle.splits.v1beta1.transactions.unwrap.Message": {
    aminoType: "/assetmantle.splits.v1beta1.transactions.unwrap.Message",
    toAmino: ({
      from,
      fromID,
      ownableID,

...
export const createRPCMsgClient = async ({
  ...
  assetmantle: {
    splits: {
      v1beta1: {
        transactions: {
          send: new (await import("./splits/internal/transactions/send/transactionService.v1.rpc.msg")).MsgClientImpl(rpc),
          unwrap: new (await import("./splits/internal/transactions/unwrap/transactionService.v1.rpc.msg")).MsgClientImpl(rpc),
          wrap: new (await import("./splits/internal/transactions/wrap/transactionService.v1.rpc.msg")).MsgClientImpl(rpc)
        }
      }
    }
  },

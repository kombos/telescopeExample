...
export const Params = {
  ...
  toJSON(message: Params): unknown {
    ...
    message.minChainFeeBasisPoints !== undefined && (obj.minChainFeeBasisPoints = (message.minChainFeeBasisPoints || Long.UZERO).toString());
    return obj;
  },
  ...
  fromAmino(object: ParamsAmino): Params {
    return {
      ...
      minChainFeeBasisPoints: Long.fromString(object.min_chain_fee_basis_points)
    };
  },
